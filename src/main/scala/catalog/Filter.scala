//package catalog
//
//import catalog.pojos.{RawItem, ScoreItem}
//
//object Filter {
//
//  def itemFilter(item: RawItem, categories: List[String]): Boolean = {
...
//  }
//
//  def completeFilter(item: RawItem, minimumScore: Double, scoreItem: ScoreItem): Option[ScoreItem] = {
...
//  }
//
//  def filterByScoreItems(item: RawItem, minimumScore: Double, scoreItems: List[ScoreItem]): List[(String, RawItem)] = {
//    scoreItems
